...
describe('Adjuster', () => {
  describe('When the whole timeline is enabled', () => {
    test.each([
      [2001, 1],
      [3000, 1],
      [4000, 1],
      ...
      [8100, 4],
      [11000, 4],
    ])('Determines the correct period', (reference, expected) => {
      const timeline = [
  ...
  describe('When the timeline is partially enabled', () => {
    test.each([
      [2001, 1],
      [3000, 1],
      [4000, 1],
  ...
  describe('When the timeline is partially enabled for the last 2 periods', () => {
    test.each([
      [6500, 3],
      [8000, 3],
      [8100, 4],
